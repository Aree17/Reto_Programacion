package com.unl.reto.base.controller.dao;
...
public class AdapterDao<T> implements InterfaceDao<T> {
    ...
    public void delete(Integer id) throws Exception {
        ...
        // Se busca el elemento con el id especificado
        ...
        // Si se encuentra el elemento, se elimina y se guarda el json actualizado, caso contrario presenta una excepción

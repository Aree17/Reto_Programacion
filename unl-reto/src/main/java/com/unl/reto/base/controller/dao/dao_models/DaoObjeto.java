...
public class DaoObjeto extends AdapterDao<Objeto>{
    ...
    public LinkedList<HashMap<String, Object>> all() {
        ...
        if (!this.listAll().isEmpty()) {
            Objeto[] arreglo = this.listAll().toArray();
    ...
    private HashMap<String, Object> toDict(Objeto arreglo) {
    ...
    public LinkedList<HashMap<String, Object>> search(String attribute, String text, Integer type) throws Exception {
        ...
        if (!lista.isEmpty()) {
            lista = orderByObjeto(Utiles.ASCENDENTE, attribute);
